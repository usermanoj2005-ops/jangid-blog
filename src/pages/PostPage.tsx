        ...
        <div>
          <div className="font-medium text-neutral-900 flex items-center gap-1.5">
            ...
            {user && post.authorId === user.uid && (
              <span className="text-[10px] bg-neutral-100 text-neutral-500 px-1.5 py-0.5 rounded-md font-sans">You</span>
            )}
          </div>
            ...
            <div key={comment.id} className="flex gap-4">
              ...
              <div className="flex-1">
                <div className="bg-neutral-50 rounded-2xl p-4">
                  <div className="flex items-center justify-between mb-1">
                    <span className="font-semibold text-neutral-900 text-sm flex items-center gap-1.5">
                      ...
                      {user && comment.userId === user.uid && (
                        <span className="text-[9px] bg-neutral-200 text-neutral-600 px-1 py-0.5 rounded font-sans">You</span>
                      )}
                    </span>
                  ...
                  <p className="text-neutral-800 break-words mt-1">{comment.text}</p>
                </div>
